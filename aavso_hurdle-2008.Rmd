---
title: "Cycle 24 Hurdle "
author: "A collection of interesting people..."
...
da1=read.csv("aavso_hurdle-2008.csv",header=TRUE)
head(da1)
...
I did some experimenting with the ARIMA model to determine how many parameters to use in a hurdle model. I found that more than 4 seasonal periods and more then 1 harmonic tested as insignificant. However, the tests assume that the residuals are iid normal, which they are not. It also showed an ARMA order greater than (3,3) was not significant. auto.arima tested models up to (10,10). We're going to try with the geometric distribution compared to the negbin. 
...
m <- hurdle(y ~ ., data = df, dist = "geometric", zero.dist = "binomial")
# same as this:
...
Plots of the fitted data and original data with negbin 
...
cat("\n\n")
plot_fit(f,ds,first=450,main="g, First 450")
cat("\n\n")
plot_fit(f,ds,first=2250,main="g, First 2250")
cat("\n\n")
plot_fit(f,ds,first=4500,main="g, First 4500")
...
###Residuals
Residuals don't show as strong of a seasonal pattern remaining.
